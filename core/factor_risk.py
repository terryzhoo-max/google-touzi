FACTOR_REGISTRY = {
    "CSI300_ETF": {
        ...
        "macro": {"equity_beta": 0.95, "liquidity_sensitivity": 0.45},
    ...
    "CSI500_ETF": {
        ...
        "macro": {"equity_beta": 1.05, "liquidity_sensitivity": 0.65},
    ...
    "STAR50_ETF": {
        ...
        "macro": {"equity_beta": 1.15, "liquidity_sensitivity": 0.7},
    ...
    "HSTECH_ETF": {
        ...
        "asset_class": {"equity": 1.0},
        "strategy": {"technology": 1.0},
        "macro": {"equity_beta": 1.2, "liquidity_sensitivity": 0.75, "dollar_sensitivity": 0.35},
    ...
    "SP500_ETF": {
        ...
        "asset_class": {"equity": 1.0},
        "strategy": {"broad_market": 1.0},
        "macro": {"equity_beta": 1.0, "dollar_sensitivity": 0.45, "rate_sensitivity": 0.35},
        "theme": {"US equity": 1.0},
    },
    "NASDAQ_ETF": {
        "region": {"US": 1.0},
        ...
        "macro": {"equity_beta": 1.1, "dollar_sensitivity": 0.5, "rate_sensitivity": 0.55},
    ...
    "NIKKEI225_ETF": {
        ...
        "macro": {"equity_beta": 0.9, "dollar_sensitivity": 0.3},
    ...
    "CHIP_ETF": {
        ...
        "asset_class": {"equity": 1.0},
        "strategy": {"technology": 1.0},
        "macro": {"equity_beta": 1.2, "liquidity_sensitivity": 0.75},
    ...
    "GOLD_ETF": {
        ...
        "macro": {"inflation_sensitivity": 0.8, "dollar_sensitivity": -0.35, "equity_beta": -0.05},
